...
print("Reverse Complements of Primers:", reverse_complement(primer))
print("Reverse Complement of Reverse Primer:", reverse_complement(reversePrimer))
